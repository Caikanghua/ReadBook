...
<body>  
    <form action="http://localhost:8080/pubPost.do" method="post" enctype="multipart/form-data">  
   		<input id="name" name="userId" value="123">     
   		<input id="author" name="content" value="内容">     
   		<input id="pubHouse" name="bookId" value="bookId">     
   		<input id="pubHouse" name="title" value="title">     
